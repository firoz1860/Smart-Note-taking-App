...
import { PenTool, Sparkles, Brain, Shield, ArrowRight, Zap, Users, Globe } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden sm:block">
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Smart Note</h1>
              <p className="text-xs text-gray-500 dark:text-gray-400">AI-Powered Writing</p>
            </div>
          </div>
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <Button 
              ...
              variant="ghost"
              className="hover:bg-blue-50 dark:hover:bg-blue-950 hidden sm:inline-flex"
            >
              Sign In
            </Button>
            <Button 
      ...
      <main className="container mx-auto px-4 py-8 sm:py-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-12 sm:mb-16 leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-20">
            ...
            <div className="group bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 dark:border-gray-700">
              <div className="bg-blue-100 dark:bg-blue-900 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Enhance your notes with AI-powered editing that improves clarity, 
                structure, and readability while preserving your original ideas.
              </p>
            </div>

            {/* Smart Titles */}
            <div className="group bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 dark:border-gray-700">
              <div className="bg-emerald-100 dark:bg-emerald-900 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Generate relevant, engaging titles automatically based on your 
                note content to keep your thoughts organized and findable.
              </p>
            </div>

            {/* Secure Storage */}
            <div className="group bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100 dark:border-gray-700">
              <div className="bg-purple-100 dark:bg-purple-900 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
              ...
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                Your notes are safely stored in the cloud with Firebase, 
                accessible from any device with enterprise-grade security.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            <Button
              size="lg"
              onClick={() => router.push('/auth/signup')}
              className="w-full sm:w-auto text-lg px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 group"
            >
            ...
            <Button
              ...
              variant="outline"
              onClick={() => router.push('/auth/login')}
              className="w-full sm:w-auto text-lg px-8 py-4 border-2 hover:bg-gray-50 dark:hover:bg-gray-800"
            >
              Sign In
            </Button>
          </div>
